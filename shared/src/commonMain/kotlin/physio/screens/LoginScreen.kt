...
fun LoginScreen(loginViewModel: LoginViewModel) {
    ...
    val showProgress = loginViewModel.showProgress.collectAsState()

    LaunchedEffect(loginViewModel.loginMessage) {
    ...
    fun performLogin() {
        loginViewModel.email = emailState.value.text
        loginViewModel.password = passwordState.value.text
